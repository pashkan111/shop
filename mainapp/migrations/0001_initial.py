    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('finalprice', models.DecimalField(decimal_places=1, max_digits=9, verbose_name='цена всего')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('finalprice', models.DecimalField(decimal_places=1, max_digits=9, verbose_name='финальная цена')),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_cartproduct', to='mainapp.cart', verbose_name='корзина')),
